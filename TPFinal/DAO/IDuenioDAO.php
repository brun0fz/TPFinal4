...
class DuenioDAO implements IDuenioDAO
{
    ...
    private function SaveData()
    {
        ...
        foreach ($this->duenioList as $duenio) {
            ...
            if (isset($duenio->getListaMascotas())) {
    ...
    private function RetrieveData()
    {
        ...
        if (file_exists("Data/duenio.json")) {
            ...
            foreach ($arrayToDecode as $valuesArray) {
                ...
                $valuesArrayMascotas = $valuesArray["listaMascotas"]

                foreach($valuesArrayMascotas as $valuesArrayMascota){
                        ...
                        $valuesArrayMascota["rutaVideo"];
                        $valuesArrayMascota["rutaPlanVacunas"];
                        $valuesArrayMascota["alta"];

                }
                    

                    $duenio->setListaMascotas();
                array_push($this->duenioList, $duenio);
            }
        }
    }
