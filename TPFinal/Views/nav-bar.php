...
<nav class="p-3 mb-3 border-bottom">
    <div class="container">
        ...
        <a href="<?php echo FRONT_ROOT . "Duenio/ShowDuenioHome"; ?>" class="nav-link px-2 link-secondary"><img src=<?php echo IMG_PATH . "logo2.png" ?> class="img-unselect" width="36" height="36"></a>
