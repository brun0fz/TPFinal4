    ...
    <div class="row g-5">
        ...
        <div class="col-md-5 order-md-last">
            ...
            <ul class="list-group mb-3" id="listCheckout">
                ...
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <h6 class="my-2 text-primary">Total Cupón de Pago</h6>
            ...
            <form action="<?php echo FRONT_ROOT ?>Reserva/PagarCupon" method="Post">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="numero" class="form-control" id="cc-numero" placeholder="xxxx-xxxx-xxxx-xxxx" required>
                    </div>
                    <div class="col-md-3">
                        <label for="cc-vencimiento" class="form-label">Vencimiento</label>
                        <input type="text" name="vencimiento" class="form-control" id="cc-vencimiento" placeholder="mm/aa" required>
                    </div>
                    <div class="col-md-3">
                        <label for="cc-cvv" class="form-label">CVV</label>
                        <input type="text" name="cvv" class="form-control" id="cc-cvv" placeholder="xxx" required>
                    </div>
                </div>
