        ...
        <div class="col-12 col-sm-4 border border-secundary border-end-0 p-0">
            <ul class="list-group list-group-flush">
                <?php foreach ($userList as $user) { ?>
                    <a class="list-group-item list-group-item-action py-4 d-flex border-bottom <?php if ($user2->getId() == $user->getId()) {
                                                                                                    echo "active";
                                                                                                } ?>" href="<?php echo FRONT_ROOT . "Chat/ShowChatView/" . $user->getId() ?>">
